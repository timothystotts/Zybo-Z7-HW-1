...
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33     } [get_ports { gpio_2pir_tri_i[0] }]; #IO_L11P_T1_SRCC_34 Sch=jd_p[3]            
...
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { gpio_2pir_tri_i[1] }]; #IO_L3N_T0_DQS_34 Sch=je[7]                  
